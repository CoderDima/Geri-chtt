(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".body-main-slider__slider")) new swiper_core_Swiper(".body-main-slider__slider", {
            ...
            if (document.querySelector(".main-bar__slider")) new swiper_core_Swiper(".main-bar__slider", {
                modules: [ Navigation, Pagination, EffectFade, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".hours__slider")) new swiper_core_Swiper(".hours__slider", {
                modules: [ Navigation, Pagination, EffectFade, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
